        ...
        <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
          {displayProjects.map((project, index) => (
            <Link key={project.id} href={`/projects/${project.slug}`} className="block">
              <Card className="flex flex-col animate-fade-in-up hover:shadow-lg transition-all hover:-translate-y-1 h-full cursor-pointer" style={{ animationDelay: `${200 + index * 100}ms` }}>
                ...
                <CardContent className="flex-1">
                  ...
                  <div className="flex gap-2">
                    ...
                    {project.live_url && (
                      <Button size="sm" asChild onClick={(e) => e.preventDefault()}>
